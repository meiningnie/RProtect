...
RPSTATUS PreFlt_NtCreateFile(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		...
		ULONG CreateDisposition = (ULONG)pFltContext->ulpXxx8;
		ULONG CreateOptions = (ULONG)pFltContext->ulpXxx9;
...
RPSTATUS PreFlt_NtDeleteFile(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		POBJECT_ATTRIBUTES ObjectAttributes = (POBJECT_ATTRIBUTES)pFltContext->ulpXxx1;
...
RPSTATUS PreFlt_NtSetInformationFile(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE FileHandle = (HANDLE)pFltContext->ulpXxx1;
		FILE_INFORMATION_CLASS FileInformationClass = (FILE_INFORMATION_CLASS)pFltContext->ulpXxx5;
...
RPSTATUS PreFlt_NtSetInformationFile(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		PVOID FileInformation = (PVOID)pFltContext->ulpXxx3;
		ULONG ulLength = (ULONG)pFltContext->ulpXxx4;
		FILE_INFORMATION_CLASS FileInformationClass = (FILE_INFORMATION_CLASS)pFltContext->ulpXxx5;
...
RPSTATUS PreFlt_NtLoadDriver(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		PUNICODE_STRING DriverServiceName = (PUNICODE_STRING)pFltContext->ulpXxx1;
...
RPSTATUS PreFlt_NtSetSystemInformation(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		SYSTEM_INFORMATION_CLASS SystemInformationClass = (SYSTEM_INFORMATION_CLASS)pFltContext->ulpXxx1;
		PVOID SystemInformation = (PVOID)pFltContext->ulpXxx2;
		ULONG SystemInformationLength = (ULONG)pFltContext->ulpXxx3;
...
RPSTATUS PreFlt_NtCreateSection(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	{
		ACCESS_MASK DesiredAccess = (ACCESS_MASK)pFltContext->ulpXxx2;
		ULONG SectionPageProtection = (ULONG)pFltContext->ulpXxx5;
		ULONG AllocationAttributes = (ULONG)pFltContext->ulpXxx6;
		HANDLE FileHandle = (HANDLE)pFltContext->ulpXxx7;
...
RPSTATUS PreFlt_NtCreateUserProcess(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		PRTL_USER_PROCESS_PARAMETERS ProcessParameters = (PRTL_USER_PROCESS_PARAMETERS)pFltContext->ulpXxx9;
...
RPSTATUS PreFlt_NtCreateSymbolicLinkObject(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		PUNICODE_STRING TargetName = (PUNICODE_STRING)pFltContext->ulpXxx4;
...
RPSTATUS PreFlt_NtCreateThread(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE ProcessHandle = (HANDLE)pFltContext->ulpXxx4;
...
RPSTATUS PreFlt_NtSuspendProcess(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE Process = (HANDLE)pFltContext->ulpXxx1;
...
RPSTATUS PreFlt_NtSuspendThread(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE ThreadHandle = (HANDLE)pFltContext->ulpXxx1;
...
RPSTATUS PreFlt_NtAssignProcessToJobObject(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE ProcessHandle = (HANDLE)pFltContext->ulpXxx2;
...
RPSTATUS PreFlt_NtWriteVirtualMemory(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		...
		ULONG BufferLength = (ULONG)pFltContext->ulpXxx4;
...
RPSTATUS PreFlt_NtProtectVirtualMemory(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		HANDLE ProcessHandle = (HANDLE)pFltContext->ulpXxx1;
		PVOID * BaseAddress = (PVOID *)pFltContext->ulpXxx2;
		ULONG NewProtect = (ULONG)pFltContext->ulpXxx4;
...
RPSTATUS PreFlt_NtSystemDebugControl(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		ULONG ControlCode = (ULONG)pFltContext->ulpXxx1;
		pCurEproc = PsGetCurrentProcess();
		pusCurProcName = GetProcNameByEproc(pCurEproc);
...
RPSTATUS PreFlt_NtUserSetWindowsHookEx(PFLT_CONTEXT pFltContext, PHOOK_OBJECT pHookObj)
{
	...
	__try
	{
		ULONG ulMod = (ULONG)pFltContext->ulpXxx1;
		PUNICODE_STRING ModuleName = (PUNICODE_STRING)pFltContext->ulpXxx2;
		ULONG ThreadId = (ULONG)pFltContext->ulpXxx3;
		ULONG_PTR HookId = (ULONG_PTR)pFltContext->ulpXxx4;
		ULONG_PTR HookProc = (ULONG_PTR)pFltContext->ulpXxx5;
